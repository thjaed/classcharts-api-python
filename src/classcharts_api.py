...
class GlobalClient:
  ...
  def get_attendance(self, from_date="1970-01-01",to_date=datetime.datetime.now().strftime("%Y-%m-%d")):
  ...
  def get_activity(self, from_date="1970-01-01", to_date=datetime.datetime.now().strftime("%Y-%m-%d"), last_id=None):
    if not self.student_id:
      raise ValueError("No student selected")
    else:
      if last_id:
  ...
  def get_behaviour(self, from_date="1970-01-01", to_date=datetime.datetime.now().strftime("%Y-%m-%d")):
    if not self.student_id:
      raise ValueError("No student selected")
    else:
  ...
  def get_homework_tasks(self, from_date="1970-01-01",to_date=datetime.datetime.now().strftime("%Y-%m-%d"), display_date="issue_date"):
    if not self.student_id:
      raise ValueError("No student selected")
    else:
  ...
  def get_lessons(self, date=datetime.datetime.now().strftime("%Y-%m-%d")):
    if not self.student_id:
      raise ValueError("No student selected")
    else:
